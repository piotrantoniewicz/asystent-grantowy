  ...
  return (
    ...
    >
      <body className="flex h-full flex-col overflow-hidden bg-background text-foreground">
        {/* Okno przeglądarki się nie przewija — przewija się ta ramka (strony
            tekstowe) albo obszar wiadomości w czacie. Dzięki temu menu boczne
            i nagłówek czatu stoją w miejscu. */}
